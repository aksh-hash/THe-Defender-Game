...
public class Background extends JPanel implements Runnable {
    ...
    private String whirl = "/Images/Whirl.png";                 //Sets strings to image names
    private String background = "/Images/Game Background.JPG";
    private String storyIntro = "/Images/Story Intro.jpg";
    private String mission = "/Images/Mission.jpg";
    private String instructions = "/Images/Instructions.jpg";
    private String spellBar = "/Images/SpellBar.jpg";
    private String menuscreen = "/Images/Title Screen.jpg";
    private String death = "/Images/Explosion.GIF";
    ...
    public void gameOver(Graphics g) {
        ...
        temp = "You lasted for a total of " + (timeCount / 25) + " seconds.";
        g.drawString(temp, 250, 315);
        if (score > pastScore) {
            temp = "Congradulations... you have beaten the legendary high score...";
